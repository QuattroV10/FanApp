...
class CheckField{
    ...
    private func validView(_ parentView: UIView, _ field: UITextField, _ valid: Bool){
        if valid{
            field.backgroundColor = #colorLiteral(red: 0.6000000238, green: 0.6000000238, blue: 0.6000000238, alpha: 1)
            parentView.backgroundColor = #colorLiteral(red: 0.6000000238, green: 0.6000000238, blue: 0.6000000238, alpha: 1)
